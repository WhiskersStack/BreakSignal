...
| Order | Screen | What To Show | Draft Caption |
| --- | --- | --- | --- |
| 1 | Main timer | Clear timer, status, and primary controls | Build a calmer break rhythm |
| 2 | Break reminder modal | Reminder message with Done, Snooze, and Skip | Pause when your next reset signal arrives |
| 3 | Break type selection | Eye, stretch, walking, posture, and focus options | Choose reminders that fit your workday |
| 4 | Settings and themes | Cadence, sound, volume, and visual theme controls | Tune the experience to your routine |
| 5 | Daily stats and history | Daily count, breakdown, streak, and recent activity | See your recent break rhythm |
